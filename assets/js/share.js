	...
	share: function (id, url, title, desc) {
		...
		switch (id) {
			...
			case 'ok':
				...
				break;
			case 'whatsapp':
				this.popupCenter('https://api.whatsapp.com/send?text=' + title + ' ' + url);
				break;
			case 'telegram':
				this.popupCenter('https://t.me/share/?url=' + url + '&text=' + title);
				break;
			case 'email':
				this.popupCenter('mailto:?subject=' + title + '&body=' + url);
				break;
		}
	},
	newTab: function (url) {
...
jQuery(document).ready(function ($) {
	$('.social-share a').on('click', function () {
		...
		if (id) {
			...
			var url = data.attr('data-url') || location.href,
